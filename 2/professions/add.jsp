		...
		<table width="100%" height="20" border="0" cellpadding="0"
			...
			<tr>
				<td height="20" class="title_s">
					<font color="white"><b>添加专业</b> </font>
				</td>
			</tr>
			<tr>
...
<table width="100%" border="0" align="center" cellpadding="3"
	...
	<html:form action="/professions/add" method="post">
			...
			<tr bgcolor="c6ebde">
				...
				<td width="71%" bgcolor="c6ebde">
					<html:select property="collage.id">
						<html:optionsCollection name="collages" value="id" label="name"/>
					</html:select>
					*从数据库中检索
					<br>
				</td>
