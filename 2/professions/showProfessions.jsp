...
.eXtremeTable .tableTotalEmpty {
	...
	<body style="margin: 25px;" bgcolor=#39867b>
		...
		<td width="910"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="20" class="title_s"><font color="white"><b>专业管理</b></font></td>
          </tr>
          <tr>
		...
		<br>
		<ec:table items="professionslist"
			action="${pageContext.request.contextPath}/professions/list.do"
			imagePath="${pageContext.request.contextPath}/images/table/*.gif"
			title="提示您：输入框输入数据可进行搜索查询" width="96%" rowsDisplayed="10" var="professions">
			<ec:exportXls fileName="professions.xls" tooltip="Excel" />
			<ec:row>
				<ec:column property="name" title="专业姓名" /> 
                <ec:column property="collage.name" title="所属学院">
                 </ec:column>
                 
				<ec:column sortable="false" filterable="false" viewsDenied="xls"
					alias="id1" title="删除">
					<html:link action="/professions/delete?id=${professions.id}"
						onclick="return confirm('确定删除该专业？')"> 
				 <%
