...
.eXtremeTable .tableTotalEmpty {
	...
	<body style="margin: 25px;" bgcolor=#39867b>
			...
			<table width="100%" height="20" border="0" cellpadding="0"
				...
				<tr>
					<td height="20" class="title_s">
						<font color="white"><b>查看老师对自己选课的审批情况</b> </font>
					</td>
				</tr>
				<tr>
		...
		<br>
		<ec:table items="scorelist1" 
			action="${pageContext.request.contextPath}/score/listSelf1.do"
			imagePath="${pageContext.request.contextPath}/images/table/*.gif"
			title="提示您：输入框输入数据可进行搜索查询" rowsDisplayed="5" var="score">
			...
			<ec:row>
				...
				<ec:column sortable="false" filterable="false" viewsDenied="xls"
					alias="id2" title="状态" >
							...
							<c:if test="${score.state==-1}"><font color="blue">待审核</font></c:if>
				</ec:column>
			</ec:row>
		</ec:table>
