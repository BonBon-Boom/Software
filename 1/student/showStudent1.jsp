...
.eXtremeTable .tableTotalEmpty {
	...
	<body style="margin: 25px;" bgcolor=#39867b>
		...
		<br>
		<ec:table items="changePsw" 
			action="${pageContext.request.contextPath}/student/changePsw.do"
			...
			<ec:row>
				...
				<ec:column sortable="false" filterable="false" viewsDenied="xls"
					alias="id1" title="编辑">
					<html:link action="/student/toEdit?id=${student.id}" onclick="return confirm('确定修改个人密码？')"><font color="blue">点击修改密码</font></html:link>
				</ec:column>
			</ec:row>
		</ec:table>
